...
<html>
    <head>
        <meta charset="UTF-8">
        <title>List of Complaint / NC By Topic Category</title>
    </head>
    <body>
        ...
        <div class="container" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);padding: 30px;">
            <h1 class="head_text">LIST OF Complaint / NC By Topic Category</h1><hr>
             ...
             <table id="view_nc" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;">TOPIC CATEGORY</th>
                ...
                <tbody>
<?php foreach ($viewby_topic_cat as $l_nc): ?>
                    <tr>
                        <?php  
