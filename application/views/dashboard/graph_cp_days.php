                ...
                point: {
                    ...
                    events: {
                        ...
                        click: function () {
                            ...
                            location.href = 'http://intranet.saleecolour.com/intsys/complaint/dashboard/view_gpcat_detail/' +this.name;
          ...
          name:"Topic Category of month",
            ...
            data: [
             ...
             foreach ($graph_cp_day->result_array() as $graph_cp_days){
                 ...
                 $date_format = $graph_cp_days['cp_month']."/".$graph_cp_days['cp_year'];
