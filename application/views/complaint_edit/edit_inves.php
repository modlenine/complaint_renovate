    ...
    <div class="panel-heading">Investigation (Edit)</div>
      ...
      <div class="panel-body">
                ...
                <div class="col-md-12 pri">
                    ...
                    <input hidden="" type="text" name="cp_detail_inves_usermodify" id="cp_detail_inves_usermodify" value="<?php echo $getuser['Dept']; ?>" />
