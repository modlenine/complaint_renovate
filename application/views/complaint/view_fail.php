...
<html>
    ...
    <body>
        ...
        <div class="container" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);padding: 30px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input hidden="" type="text" name="history_cptopic" id="history_cptopic" value="<?php echo $view_cp['topic_name']; ?>" />
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="history_cptopiccat" id="history_cptopiccat" hidden="" value="<?php echo $view_cp['topic_cat_name']; ?>" />
                        </div>
                    </div>
            ...
            <?php 
            if($view_cp['cp_no_old']!= ""){
                $start_investigate = "complaint/inves_starting_fail/";
            }else{
                $start_investigate = "complaint/inves_starting/";
            }
                
            ?>
            <div class="btn_start_inves result_pms"><a href="<?php echo base_url($start_investigate); ?><?php echo $view_cp['cp_no']; ?>"><button name="btn_v_cp" id="btn_v_cp" onclick="javascript:return confirm('คุณต้องการเริ่มการสืบสวนใช่หรือไม่');" class="btn btn-primary">Start Investigation</button></a></div>
